...
@testset "MeshBodies.jl" begin
    ...
    mesh = Mesh(Point{3, Float64}.([[0.,0.,0.],[1.,0.,0.],[1.,1.,0.]]), 
    ...
    # the MeshBody
    b1 = MeshBody(mesh,mesh,(1,1),(x,t)->x,Rect(0.,0.,0.,1.,1.,1.),1.0,1/2,true)
    b2 = copy(b1)
    ...
    sphere = MeshBody(mesh,mesh,(1,1),(x,t)->x,Rect(mesh.position),1.0,1/2,true)
